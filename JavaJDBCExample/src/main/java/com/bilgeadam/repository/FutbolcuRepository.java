...
public class FutbolcuRepository implements ICrud<Futbolcu> {
    ...
    public void save(Futbolcu futbolcu) {
        ...
        String sql = "INSERT INTO futbolcu (ad, mevki, forma_no, deger, takim_id) VALUES ('" +
                futbolcu.getAd() + "','" +
                futbolcu.getMevki() + "'," +
                futbolcu.getFormaNo() + "," +
                futbolcu.getDeger() + "," +
    ...
    // CTRL + ALT + T İstediğimiz Bloğu try - catch Yapısına Almamızı Sağlar
    @Override
